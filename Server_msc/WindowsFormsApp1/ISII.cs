...
namespace WindowsFormsApp1 {
    class ISII {
        ...
        public void ISII_Insegnante(string nome, string cognome, string numero) {
            Array.Resize(ref DB_InsegnantiISII, DB_InsegnantiISII.Length + 1);
            DB_InsegnantiISII[DB_InsegnantiISII.Length - 1] = nome + " " + cognome + " " + numero;

        }

        public void ISII_Allievo(string nome, string cognome, string numero) {
            Array.Resize(ref DB_InsegnantiISII, DB_InsegnantiISII.Length + 1);
            DB_InsegnantiISII[DB_InsegnantiISII.Length - 1] = nome + " " + cognome + " " + numero;
